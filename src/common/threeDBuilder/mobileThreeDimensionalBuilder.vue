<template>
  <div class="builder fixedBuilder">
    <div class="main_wrapper" id="mainWrapper">
      <div id="container" class="clearfix" @click="containerListenner" @mousedown="containerMouseDown" @mousemove="containerMouseMove" @mouseup="containerMouseUp"></div>
      <div class="show_more clearfix" @click="showMoreFn()" :class="showMore?'':'show_more_close'"><img src="/image/3dBuilder/arrow.png" alt=""></div>
      ...
      <div id="childWrapper" v-show="shapesListShow || cartoonStlShow">
        <div class="child_wrapper normal_wrapper" v-if="shapesListShow">
          ...
          <div v-for="(item, index) in shapesList"
            ...
            <div class="drag sprint" :class="'sprint_'+item.title" v-lazy:background-image="'/image/3dBuilder/3dPrinting/sprint_'+item.title+'.png'"></div>
        ...
        <div class="child_wrapper cartoon_wrapper" v-if="cartoonStlShow">
          ...
          <div v-for="(item, index) in cartoonStlList"
            ...
            <div class="drag sprint sprintY" :class="'sprint_'+item.title" v-lazy:background-image="'/image/3dBuilder/3dPrinting/sprint_'+item.title+'.png'"></div>
            <div class="name drag">{{item.name}}</div>
          </div>
        </div>
      </div>
      <div class="module_btns clearfix">
        <div class="btn_main go_mainPage" @click="hideSelf()">
    ...
    <div class="save_name_module">
      ...
      <div class="btn_wrapper clearfix">
        <img src="/image/3dBuilder/3dPrinting/btn_yes1.png" class="save_name_ok" @click="exportMoudle(0)">
    ...
    <div class="save_ask">
      ...
      <div class="btn_wrapper clearfix">
        ...
        <img src="/image/3dBuilder/3dPrinting/btn_close.png" class="imgBtn save_name_cancle" @click="hideGoHome()">
      </div>
    </div>
    <div class="note">
    ...
    <div class="text_window" v-if="showTextWindow">
      ...
      <input type="text" placeholder="请输入文字" maxlength="10" id="textContent" @input="textInputFn"
             @blur="textInputFn">
      <div class="btn_wrapper clearfix">
        <div class="btns btn_ok text_ok" :class="inputCanConfirm?'':'btn_disable'" @click="inputCanConfirm?insertWord():null">确定</div>
    ...
    <div id="loading_data" :class="showMore?'hideShowMore':''" v-if="showLoading"><img src="/image/3dBuilder/loading.gif" alt="">
      <div class="processingbar"><div class="barwidth" :style="{width:progressingBar+'%'}"></div></div></div>
  </div>
</template>

<script>
    import '@/assets/3dBuilder/common.css';
    // import '@/assets/3dBuilder/3dPrinting.css';
    ...
    export default {
        ...
        methods:{
            ...
            changeControls( type ) {
                if(window.deleteObjFlag){return}
                this.showColorOption = false;
